...
/** Removing "(difficultyWeightFactoryClass = QueenDifficultyWeightFactory.class)" in line below gives following error:
Exception in thread "main" java.lang.IllegalArgumentException:
The sorterManner (DECREASING_DIFFICULTY) on entity class (class org.optaplanner.examples.nqueens.domain.Queen) fails
because that entity class's @PlanningEntity annotation does not declare any difficulty comparison.
**/
...
public class Queen extends AbstractPersistable {
    ...
    public int getColumnIndex() { return column.getIndex(); }
    ...
    public int getDescendingDiagonalIndex() { return (getColumnIndex() - getRowIndex()); }

    @Override
    public String toString() { return "Queen-" + column.getIndex(); }
}
